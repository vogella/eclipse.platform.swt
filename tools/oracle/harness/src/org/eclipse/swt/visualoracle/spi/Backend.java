 ...
 * front of one SWT rendering stack (stock native, a Skija renderer, ...).
 *
 * Backend ids for the backends built by {@code tools/oracle/build.sh} are
 * fixed: {@code native}, {@code skia-canvas}, {@code skija-proto}. Results
 * reference backends by id, so ids must never change meaning.
 *
